...
public class Animal extends Actor {
	...
	double movement = 10.1 * 2; // 13.3333333
	double movementX = 10.666666 * 2; // 10.666666
	int imgSize = 40;
	...
	public void act(long now) {
		...
		if (carDeath) {
			...
			if (carD == 4) {
				...
				noMove = false;
				/*
				 * if (points > 50) { points -= 50; changeScore = true; }
				 */
			}
		...
		if (getIntersectingObjects(Log.class).size() >= 1 && !noMove) {
			 ...
			 * System.out.println("Reached"); end--; //points -= 50; }
			 */
			points += 50;
			changeScore = true;
			w = 800;
