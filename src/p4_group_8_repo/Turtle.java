...
public class Turtle extends Actor {
	...
	public Turtle(int n, int xpos, int ypos, int s, int w, int h) {
		...
		if(n==2) {
			...
			turtle2 = new Image("file:src/p4_group_8_repo/TurtleAnimation22.png", w, h, true, true);
			turtle3 = new Image("file:src/p4_group_8_repo/TurtleAnimation23.png", w, h, true, true);
		}
